...
methods:{
    refreshData(){
        ...
        axios.get(Constantes.API_URL+"departamento")
        .then((response)=>{
    ...
    crearClick(){
        axios.post(Constantes.API_URL+"empleado",{
    ...
    actualizarClick(){
        axios.put(Constantes.API_URL+"empleado",{
    ...
    borrarClick(id){
        ...
        axios.delete(Constantes.API_URL+"empleado/"+id)
        .then((response)=>{
            this.refreshData();
            alert(response.data);
        });
    ...
    subirImagen(event){
        ...
        axios.post(
            Constantes.API_URL+"empleado/guardararchivo",
            formData)
            .then((response)=>{
